      ...
      final validIntJsons = [
        {
          ...
          'parsed_map': {'value1': 0, 'value2': 27, 'value3': -123},
        },
        {
      ...
      final validIntJsons = [
        {
          ...
          'parsed_map': {'value1': true, 'value2': false, 'value3': true},
        },
        {
          'text_json': '{"value1":false,"value2":false,"value3":false}',
          'parsed_map': {'value1': false, 'value2': false, 'value3': false},
        },
      ];
      for (final validData in validIntJsons) {
        final textJson = validData['text_json'] as String;
      ...
      final validIntJsons = [
        {
          ...
          'parsed_map': {'value1': 0.0, 'value2': 123.45, 'value3': -1.80e308},
        },
        {
