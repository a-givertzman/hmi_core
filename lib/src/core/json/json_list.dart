...
class JsonList<T> {
  ...
  /// TODO: doc
  JsonList.fromString(String content)
      : this._(
          Ok(content),
        );
  /// TODO: doc
  ...
  ///
  /// Creates list that parses itself from json list stored in [textFiles].
  factory JsonList.fromTextFiles(List<TextFile> textFiles) {
